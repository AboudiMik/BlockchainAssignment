...
namespace BlockchainAssignment
{
    class Transaction
    {
        ...
        public Transaction(String from, String to, double amount, double fee, String privateKey, string smartContractCode = "")
        {
        ...
        public override string ToString()
        {
            return "  [TRANSACTION START]"
                ...
                + "\n  Smart Contract: " + (string.IsNullOrEmpty(smartContractCode) ? "None" : smartContractCode)
                + "\n  [TRANSACTION END]";
        }
    }
}
